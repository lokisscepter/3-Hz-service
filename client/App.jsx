...
class App extends React.Component {
  ...
  fetchInfo(item_id) {
    return axios.get(`http://3.136.68.31:1337/api/items/${item_id}/info`)
      .then(response => {
  ...
  fetchStyles(item_id) {
    return axios.get(`http://3.136.68.31:1337/api/items/${item_id}/styles`)
      .then(response => {
  ...
  fetchSizes(item_id) {
    return axios.get(`http://3.136.68.31:1337/api/items/${item_id}/sizes`)
      .then(response => {
  ...
  fetchPhotos(item_id) {
    return axios.get(`http://3.136.68.31:1337/api/items/${item_id}/photos`)
      .then(response => {
